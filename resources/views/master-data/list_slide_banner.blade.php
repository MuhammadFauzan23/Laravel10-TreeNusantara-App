...
@section('content')
                            ...
                            <table class="table table-bordered tableView">
                                ...
                                <tbody>
                                    @php
                                        $no = 1;
                                    @endphp
                                    @foreach ($data_slide_banner as $dsb)
                                        <tr>
                                            <td class="text-center">{{ $no++ }}</td>
                                            <td>{{ $dsb->judul_slide }}</td>
                                            <td>{{ $dsb->link }}</td>
                                            @if ($dsb->status == 1)
                                                <td>Aktif</td>
                                            @else
                                                <td>Draft</td>
                                            @endif
                                            <td class="text-center"><img src="{{ asset('uploads/' . $dsb->gambar_slide) }}"
                                                    width="150" height="75"></td>
                                            <td class="text-center">
                                                <a href="" class="btn btn-warning mb-1" data-toggle="modal"
                                                    data-target="#editForm{{ $dsb->id }}"><i
                                                        class="fas fa-edit"></i></a>
                                                <a href="/list_slide_banner/proses_hapus/{{ $dsb->id }}"
    ...
    <div class="modal fade" id="addform">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form class="was-validated" action="/list_slide_banner/proses_tambah" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="judul_slide" class="form-control" id="" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="gambar_slide" class="form-control" id="" required>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Modal Edit-->
    @foreach ($data_slide_banner as $dsb)
        <div class="modal fade" id="editForm{{ $dsb->id }}" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form class="was-validated" action="/list_slide_banner/proses_edit/{{ $dsb->id }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="judul_slide" class="form-control"
                                                    id="" value="{{ $dsb->judul_slide }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        @if ($dsb->gambar_slide)
                                            <img src="{{ asset('uploads/' . $dsb->gambar_slide) }}" width="760"
                                                height="440">
                                        @else
