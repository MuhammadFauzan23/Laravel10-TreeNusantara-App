        ...
        <div class="container">
                                    ...
                                    @foreach ($data_iklan as $iklan)
                                        <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                                            <a href="{{ $iklan->link }}"><img
                                                    ...
                                                    class="d-block w-100" alt="..." height="270px" width="100%">
                                            </a>
                                        </div>
                                    @endforeach
                                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="p-3">
                        <h4 class="font-italic">Artikel terbaru</h4>
                        <hr>
                        @foreach ($post_terbaru as $post)
                            <a style="color: black" href="{{ url('/view_artikel_detail/' . $post->id) }}">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="badge badge-warning">{{ $post->kategori->nama_kategori }}</span>
                                        <a href="{{ url('/view_artikel_detail/' . $post->id) }}"><i class="fas fa-anwser">
